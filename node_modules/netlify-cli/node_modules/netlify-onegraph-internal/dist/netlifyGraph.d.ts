...
export declare const queryToFunctionDefinition: (fullSchema: GraphQLSchema, persistedQuery: ExtractedFunction, enabledFragments: Record<string, ParsedFragment>) => ParsedFunction | undefined;
...
export declare const generateFunctionsSource: (netlifyGraphConfig: NetlifyGraphConfig, schema: GraphQLSchema, operationsDoc: string, queries: Record<string, ExtractedFunction>, fragments: Record<string, ExtractedFragment>) => {
    clientSource: string;
